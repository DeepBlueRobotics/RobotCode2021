...
public class RobotContainer {
    ...
    private void configureButtonBindingsRightJoy() {
        ...
        new JoystickButton(rightJoy, Constants.OI.RightJoy.kAlignAndShootButton).whileHeld(new SequentialCommandGroup(new ShooterHorizontalAim(drivetrain, turret, lime), new Shoot(feeder)));
