...
public class RobotContainer {
    ...
    private void configureButtonBindingsController() {
        ...
        new JoystickButton(controller, Constants.OI.Controller.kLimelightToggleButton).whenPressed(new InstantCommand(() -> {intake.setLimelightSearching(!intake.isLimelightSearching());}));
