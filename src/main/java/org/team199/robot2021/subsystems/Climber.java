...
public class Climber extends SubsystemBase {
    ...
    public static final double kLiftHeight = 1.803; // Radians motor turns to bring arm to max height
    public static final double kLiftLowerHeight = 0;  //height arm starts at
